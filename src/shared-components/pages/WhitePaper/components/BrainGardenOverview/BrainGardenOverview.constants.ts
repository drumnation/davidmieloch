...
export const defaultContent = {
  hero: {
    ...
    title: "<span style=\"text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;\">THE</span><br/><span style=\"color:#2ecc71; text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000, 0 0 8px rgba(255, 215, 0, 0.9), 0 0 15px rgba(255, 165, 0, 0.7);\">BRAIN GARDEN</span><br/><span style=\"text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;\">SYSTEM</span>",
    subtitle: "<span style=\"text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;\">A Pragmatic Approach<br/>to </span><span style=\"color:#4a9eff; text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000, 0 0 8px rgba(74, 158, 255, 0.7), 0 0 12px rgba(74, 158, 255, 0.5);\">AI Integration</span>",
  },
  intro: {
    text: [
