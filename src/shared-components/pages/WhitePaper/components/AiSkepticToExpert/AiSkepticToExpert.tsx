...
export const AiSkepticToExpert: React.FC<AiSkepticToExpertProps> = ({
  ...
  const renderContent = () => (
    <S.Container className={className} key="ai-skeptic-content">
      <S.GlobalStyles />
      {/* Hero is rendered outside, no ID needed here */}
      {heroComponent}
      ...
      >
        ...
        {/* Added ID and style here */}
        {enhancedQuotesProps && (
          <div id="skeptic-quotes" style={{ scrollMarginTop: '100px' }}>
            <QuotesSection quotesProps={enhancedQuotesProps} />
          </div>
        )}

        {/* Added ID and style here */}
        <div id="skeptic-trend" style={{ scrollMarginTop: '100px' }}>
          <ContentSection>
        ...
        {/* Added ID and style here */}
        <div id="skeptic-conclusion" style={{ scrollMarginTop: '100px' }}>
          <ContentSection>
            <Typography variant="body" weight="regular" className="mb-4">
