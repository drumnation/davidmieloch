    ...
    <div className={className} style={sectionContainerWithoutMarginStyle}>
      ...
      <div style={{ ...paragraphContainerStyle, marginLeft: '1.5rem', borderLeft: '3px solid #e0e0e0', paddingLeft: '1.5rem', marginBottom: '2rem' }}>
        ...
        <div style={{ marginTop: '1rem' }}>
          <SectionParagraph>
            &quot;AI will make following best practices even more important. You need diligent code review to prevent AI slop from getting in (real code review, not rubber stamps).
          </SectionParagraph>
        </div>
        <div style={{ marginTop: '1rem' }}>
          <SectionParagraph>
            You need strong and thorough typing to provide the context needed to generate quality code.
          </SectionParagraph>
        </div>
        <div style={{ marginTop: '1rem' }}>
          <SectionParagraph>
            You need testing and thorough test coverage to prevent regressions and ensure correct behavior. You need linters to ensure best practices and avoid the cases.
          </SectionParagraph>
        </div>
        <div style={{ marginTop: '1rem' }}>
          <SectionParagraph>
            You need well thought out comments to communicate edge cases. You need CI and git hooks to enforce compliance.
          </SectionParagraph>
        </div>
        <div style={{ marginTop: '1rem' }}>
          <SectionParagraph>
            You need well thought out interfaces and well designed encapsulation to keep responsibility of each module small. You need a well thought out and clean and consistent project structure so it&apos;s clear where code should go.
          </SectionParagraph>
        </div>
