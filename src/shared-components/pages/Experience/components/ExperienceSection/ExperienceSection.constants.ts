import { ExperienceItem } from '@shared-components/pages/Experience/components/ExperienceSection/ExperienceSection.types'; // Adjust path as necessary
...
Perfect for creating professional digital menu boards, promotional displays, and information screens for Scala's digital signage ecosystem.`
    ...
    },
    {
        ...
        startDate: 'Jun 2018',
        endDate: 'Jul 2019',
        description: 'OTG operates the **largest fleet** of centrally managed, public facing iPads (**10K+ iPads**), located in US airports.',
        bulletPoints: [
...
export const OLDER_EXPERIENCE: ExperienceItem[] = [
    {
        ...
        bulletPoints: [
            ...
            'Implemented **HubSpot** and developed **marketing automation campaigns**.',
        ...
        technologies: ['Hubspot', 'HTML', 'CSS', 'Digital Marketing', 'SEO', 'Content Marketing', 'Analytics', 'Social Media'],
        sortOrder: 1,
        media: [
            {
                type: "image",
                url: "/media/uniquesound-screen.png",
                title: "UniqueSound",
                showLogo: true,
                width: "100%",
            },
            {
                type: "image",
                url: "/media/uniquesound-site1.png",
                title: "UniqueSound",
                showLogo: true,
            ...
            {
                type: "image",
                url: "/media/uniquesound-site2.png",
                title: "UniqueSound",
                showLogo: true,
            ...
            {
                type: "image",
                url: "/media/uniquesound-site3.png",
                title: "UniqueSound",
                showLogo: true,
