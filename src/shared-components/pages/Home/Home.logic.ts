    ...
    items: [
      {
        ...
        icon: 'trend',
        content: 'Crucially, AI\'s power is unlocked not just by technical skill, but by asking the right questions. An FSBP possesses the broad conceptual vocabulary spanning technology, product, marketing, and sales, allowing them to direct AI agents effectively across diverse tasks far beyond what a narrow specialist could achieve. This isn\'t just theory. We see companies like Midjourney (AI art) reaching $200M+ revenue with ~40 people, and Cursor (AI IDE) hitting ~$100M ARR with only ~20. That\'s roughly $5 million in revenue per employee – orders of magnitude higher than the ~$125k median for SaaS startups. They achieve this through mass automation and leveraging AI infrastructure – capabilities best directed by those with holistic understanding.'
      },
      {
      ...
      },
      {
        ...
        icon: 'layers',
        content: 'The FSBP brings together technical knowledge, business acumen, and the ability to direct AI tools. This creates unprecedented leverage in building and growing ventures. By understanding all aspects from code to customer, they avoid siloed thinking and translate between deep technical concepts and business strategy intuitively. This holistic view enables them to identify opportunities others miss and execute with unusual speed – seeing precisely where AI can be most effectively deployed. As AI tools become more powerful, this capacity for multi-domain thinking and the ability to steer AI to solve complex challenges becomes exponentially more valuable.'
      }
    ]
  },
  characteristics: {
