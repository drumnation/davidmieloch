/**
 * Props for the IntegrationSystemDiagram component
 */
export interface IntegrationSystemDiagramProps {
  /**
   ...
   * @default 'Integration System Diagram showing the connection between Core Integration System and Development Tools including Git, IDE, and CI/CD integrations'
   */
