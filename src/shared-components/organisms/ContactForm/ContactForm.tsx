...
export function ContactForm() {
  ...
  const { loading, error, success, setError, setSuccess, handleSubmit } =
    useContactFormHandler(form);
      ...
      <Card shadow="sm" p={{ base: "lg", md: "xl" }} radius="md" withBorder>
        {success ? (
          <Notification
            ...
            mb="lg"
          >
            Thanks! I'll review your message personally. I usually reply
            within a day or two.
            <br />
            <br />
            In the meantime, feel free to check out my{" "}
            <Link href="/bio">bio & experience</Link> or read some{" "}
        ...
        <form onSubmit={form.onSubmit(handleSubmit)}>
          <Stack gap="lg">
            ...
            <Checkbox
              label="Send occasional field notes"
              description="Practical notes about agent factories, software archaeology, and building systems that survive contact with real work."
