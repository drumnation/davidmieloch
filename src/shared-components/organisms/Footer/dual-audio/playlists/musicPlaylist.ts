...
// Updated playlist with normalized filenames
export const musicPlaylist: AudioTrack[] = [
    ...
    // Adding other downloaded tracks based on normalized names
    {
        ...
        src: '/audio/music/what-i-learned-building-a-photoshop-in-the-browser.mp3',
        artwork: '/audio/music/what-i-learned-building-a-photoshop-in-the-browser.jpg',
    ...
    },
    {
        ...
        artist: 'Music by David Mieloch', // Placeholder
        src: '/audio/music/building-with-brain-garden-real-world-lessons-in-practical-ai.mp3',
        artwork: '/audio/music/building-with-brain-garden-real-world-lessons-in-practical-ai.jpg',
        description: 'Track description placeholder.', // Placeholder
    },
    {
        id: 'the-end-of-time-a-hitchhiker-s-guide-to-the-dying-universe',
        title: "The End of Time： A Hitchhiker's Guide to the Dying Universe",
        artist: 'Music by David Mieloch', // Placeholder
        src: '/audio/music/the-end-of-time-a-hitchhiker-s-guide-to-the-dying-universe.mp3',
        artwork: '/audio/music/the-end-of-time-a-hitchhiker-s-guide-to-the-dying-universe.jpg',
        description: 'Track description placeholder.', // Placeholder
    },
    {
    ...
    {
        id: 'not-a-selfish-person',
        title: 'Not a Selfish Person',
        artist: 'Music by David Mieloch', // Placeholder
        src: '/audio/music/not-a-selfish-person.mp3',
        artwork: '/audio/music/not-a-selfish-person.jpg',
        description: 'Track description placeholder.', // Placeholder
    },
    {
