const agentPromptWritingGuide = {
  ...
  applicationProcess: {
    ...
    steps: [
      ...
      },
      {
        ...
        stepDescription: "Clearly articulate the specific task the agent needs to perform. Define the desired outcome in detail, including the expected output format, quality standards, and any specific constraints or requirements.",
        agentActions: [
      ...
      },
      {
        ...
        stepDescription: "Based on the agent's profile and the task definition, write the initial prompt. Use clear, concise language, and provide all necessary context and instructions. Incorporate the core principles of prompt engineering, such as clarity, specificity, and explicit output definition.",
        agentActions: [
      ...
      },
      {
        ...
        stepDescription: "Submit the initial prompt to the agent and carefully evaluate its response. Assess whether the agent understood the task correctly and produced the desired output. Identify any areas of confusion or misinterpretation.",
        agentActions: [
      ...
      },
      {
        ...
        stepDescription: "Based on the evaluation, refine the prompt to address any issues or ambiguities. Iterate on the prompt, testing and refining it multiple times until the agent consistently produces the desired output. Use the feedback from each iteration to improve the clarity, specificity, and effectiveness of the prompt.",
        agentActions: [
  ...
  examples: {
    description: "These examples demonstrate how to apply the principles of prompt improvement in different software development scenarios. Each use case highlights a specific aspect of prompt engineering and provides concrete examples of before-and-after prompts.",
    useCases: [
      {
        name: "Code Generation",
        scenario: "An agent is tasked with generating a Python function that sorts a list of numbers in ascending order. The initial prompt is vague, leading to incorrect output. The improved prompt provides specific instructions and constraints.",
  ...
  codeExamples: [
    ...
    {
      description: "Example of using template strings to create dynamic prompts based on runtime information. This is especially useful when prompt content needs to be adjusted based on previous agent actions or dynamic data.",
      example: {
        language: "typescript",
  ...
  commonPitfalls: [
    {
      ...
      description: "Providing too much information or unnecessary details can overwhelm the agent and lead to confusion. While context is important, it's crucial to strike a balance and avoid including irrelevant information that might distract the agent from the core task.",
      solution: "Focus on providing only the essential information needed for the task. Use concise language and avoid redundant details. Review prompts critically to identify and remove any unnecessary information.",
    ...
    },
    {
      ...
      description: "Using vague or ambiguous terms can lead to misinterpretations and incorrect outputs. Agents may struggle to understand the intended meaning, resulting in errors or unexpected behavior.",
      solution: "Use clear, precise language with a single, unambiguous interpretation. Define any terms that could have multiple meanings. Provide specific examples to illustrate the desired outcome.",
      preventativeMeasures: [
    ...
    },
    {
      ...
      description: "Failing to provide sufficient context can hinder the agent's ability to understand the task and its purpose. Without proper background information, the agent may struggle to generate relevant and accurate outputs.",
      solution: "Provide all necessary context, including relevant background information, constraints, and assumptions. Explain the purpose of the task and how it fits into the overall project. Tailor the context to the specific agent's role and knowledge base.",
      preventativeMeasures: [
    ...
    },
    {
      ...
      description: "Failing to specify or enforce a consistent output format can lead to integration issues between agents. Inconsistent data structures or formatting can disrupt the flow of information and require additional processing.",
      solution: "Clearly define the expected output format, structure, and content. Specify data types, units, and any specific formatting requirements. Provide examples of desired outputs whenever possible. Use a consistent format for similar tasks across different agents.",
      preventativeMeasures: [
    ...
    },
    {
      ...
      description: "Assigning tasks that exceed an agent's capabilities can lead to failures or suboptimal results. Prompts should be tailored to each agent's strengths and limitations.",
      solution: "Thoroughly understand each agent's capabilities and limitations. Design prompts that align with their specific roles and expertise. Avoid assigning tasks that are beyond their current capabilities.",
      preventativeMeasures: [
