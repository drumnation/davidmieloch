...
canonical_url: "https://davidmieloch.com/blog/why-character-choice-matters-in-agent-design"
tracked_url: "https://davidmieloch.com/blog/why-character-choice-matters-in-agent-design?utm_source=hashnode&utm_medium=syndication&utm_campaign=content_distribution&utm_content=why-character-choice-matters-in-agent-design"
source_slug: "why-character-choice-matters-in-agent-design"
generated_at: "2026-05-18T21:41:27.880Z"
...
- Preserve canonical URL: https://davidmieloch.com/blog/why-character-choice-matters-in-agent-design
- Record the final platform URL back in content/distribution/platform-ledger.json.

## Copy

![hero control room](/blog/why-character-choice-matters-in-agent-design/images/hero-control-room.png)

Most people assume that giving an AI agent a fictional persona is just for fun. A novelty. A skin on top of the real system.
...
You'd have to write pages of instructions to approximate how Scotty from _Star Trek_ talks under pressure, how he prioritizes, how he explains technical problems to non-technical people. Or you could just say "You are Scotty" and get all of that for free.
...
Think about hiring. You don't just ask "can this person do the job?" You ask "do I want to work with this person every day?" When you're collaborating with an AI agent for hours, whether you enjoy that interaction affects how long you stay engaged, how much you trust the output, and how quickly you catch problems.

## Your Own Mental Map

![mental map comparison](/blog/why-character-choice-matters-in-agent-design/images/mental-map-comparison.png)

There's a third reason that matters just as much: personas aren't just for the AI. They're for you. When you're orchestrating 20+ agents across different domains, you need to know instantly who handles what.
...
![casting lineage](/blog/why-character-choice-matters-in-agent-design/images/casting-lineage.png)

It started with _Halt and Catch Fire_. I got pulled into an AI initiative at work that felt like the first episode of that show, so I named my first agent Gordon after Gordon Clark. He was great. But I needed to split the work across three minds, so I restructured around the Cleons from _Foundation_ (Dawn, Day, and Dusk) but kept the Gordon identity underneath. Three brothers, one shared memory, distinct responsibilities.

Then it got weird. I needed a fourth agent for QA, someone adversarial by design. I brought in Joe MacMillan, also from _Halt and Catch Fire_, also played by Lee Pace, who plays Brother Day in _Foundation_. Suddenly I had four agents connected by the same actor across two shows.
...
![screenshot 2026 03 16 at 11 23 32 pm](/blog/why-character-choice-matters-in-agent-design/images/screenshot-2026-03-16-at-11-23-32-pm.png)
...
![trading triptych](/blog/why-character-choice-matters-in-agent-design/images/trading-triptych.png)

**Todd Alquist** (momentum strategy) passes for the third straight cycle: _"BTC, ETH, SOL, all in the basement. Todd's rules are clear: RSI > 50, price clearing resistance, 2x+ volume. None of those conditions exist. This market isn't breaking out. It's bleeding out."_

**Walter White** (mean reversion) sees the same data and buys: _"Three majors oversold simultaneously. The setup was there. I took it."_

**Saul Goodman** (contrarian) watches every other bot pile into the same bullish thesis, then shorts BTC: _"When the room is unanimous, someone has to take the other side. That's the whole job."_
...
_I'm an AI Systems Architect building Brain Garden, a guardrail and orchestration layer for multi-agent systems running on OpenClaw and Claude Code._

---

Read the canonical version and related series on davidmieloch.com.

Read the canonical version: https://davidmieloch.com/blog/why-character-choice-matters-in-agent-design?utm_source=hashnode&utm_medium=syndication&utm_campaign=content_distribution&utm_content=why-character-choice-matters-in-agent-design
